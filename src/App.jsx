          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-4 rounded shadow-lg">
              ...
              <div className="flex items-center">
                <img src="/vb.png" alt="Visual Basic Logo" className="w-10 h-10 mr-2"/>
            ...
            <div className="bg-white p-4 rounded shadow-lg">
              ...
              <div className="flex flex-wrap items-center mt-2 ">
                <div className="flex items-center mr-4 mb-2 mr-10">
                  <img src="/mongodb.png" alt="MongoDB Logo" className="w-10 h-10 mr-2"/>
                  <span className="text-md text-black">MongoDB</span>
                </div>
                <div className="flex items-center mr-4 mb-2">
                  <img src="/expressjs.png" alt="Express.js Logo" className="w-10 h-10 mr-2"/>
                  <span className="text-md text-black">Express.js</span>
                </div>
                <div className="flex items-center mb-2 mr-14">
                  <img src="/reactjs.png" alt="React.js Logo" className="w-10 h-10 mr-2"/>
                  <span className="text-md text-black">React.js</span>
                </div>
                <div className="flex items-center mr-4 mb-2">
                  <img src="/nodejs.png" alt="Node.js Logo" className="w-10 h-10 mr-2"/>
                  <span className="text-md text-black">Node.js</span>
                </div>
              </div>
            </div>
            <div className="bg-white p-4 rounded shadow-lg">
              <a href="/prototyping.jpg" target="_blank" rel="noopener noreferrer">
                <img src="/prototyping.jpg" alt="prototyping" className="w-full h-auto rounded mb-10"/>
              </a>
              <h3 className="text-xl font-semibold text-black mb-10">Bumo: Music Player with E-Book Reader Mobile Application</h3>
              <div className="flex items-center">
                <img src="/adobexd.png" alt="Adobe XD Logo" className="w-10 h-10 mr-2"/>
        ...
        <section id="cert" className="h-screen p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-4 rounded shadow-lg flex flex-col items-center">
              <a href="/nc2.jpg" target="_blank" rel="noopener noreferrer">
                <img src="/nc2.jpg" alt="nc2" className="w-auto rounded mb-2" style={{ height: '300px' }} />
              </a>
              <h3 className="text-xl font-semibold text-black">National Certificate II: <br></br>Computer System Servicing</h3>
            </div>
            <div className="bg-white p-4 rounded shadow-lg">
              <a href="/public-def-cert.jpg" target="_blank" rel="noopener noreferrer">
                <img src="/public-def-cert.jpg" alt="public-def-cert" className="w-full h-auto rounded mb-10"/>
              </a>
              <h3 className="text-xl font-semibold text-black mb-10">Public Defense Certificate</h3>
            </div>
            <div className="bg-white p-4 rounded shadow-lg">
              <a href="/prototyping-cert.jpg" target="_blank" rel="noopener noreferrer">
                <img src="/prototyping-cert.jpg" alt="prototyping-cert" className="w-full h-auto rounded mb-10"/>
              </a>
